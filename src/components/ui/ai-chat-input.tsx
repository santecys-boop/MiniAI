  ...
  (
    ...
    const startRecording = useCallback(async () => {
      ...
      function simulateText() {
        const fakeText = "Mini AI ile yeni bir uygulama tasarımı yapalım.";
    ...
    }, [handleValueChange, stopRecording, onToggleMic]);
        ...
        >
          ...
          >
            <div
              ...
              className="border border-stone-200 dark:border-stone-800 border-b-0 bg-stone-100 dark:bg-stone-800/80 rounded-t-2xl px-2 pt-2 pb-1 flex items-start gap-2 overflow-x-auto prompt-scrollbar"
            >
          ...
          <div
            ...
            className={cn(
              ...
              isImageMode
                ...
                : isWebSearchMode
                ? "border-blue-500/70 dark:border-blue-500/80 ring-1 ring-blue-500/30 shadow-blue-500/10"
          ...
          >
            ...
            <textarea
              ...
              placeholder={isImageMode ? "Görsel için bir açıklama yazın (örn: araba, kedi, m)..." : isWebSearchMode ? "🌐 Web'de aramak istediğiniz konuyu yazın..." : placeholder}
              aria-label="Prompt"
              ...
              className={cn(
                "prompt-scrollbar absolute top-0 inset-x-0 z-[1] w-full resize-none bg-transparent pl-4 pr-12 py-3.5 text-sm leading-[22px] text-stone-900 dark:text-stone-100 outline-none placeholder:font-medium placeholder:text-stone-400 dark:placeholder:text-stone-500 cursor-text",
            ...
            <div
              ref={topFadeRef}
              className="absolute left-4 right-12 top-0 z-[2] h-8 bg-gradient-to-b from-white dark:from-stone-900 via-white/90 dark:via-stone-900/90 to-transparent pointer-events-none"
            />
            <div
              ref={bottomFadeRef}
              className="absolute left-4 right-12 z-[2] h-8 bg-gradient-to-t from-white dark:from-stone-900 via-white/90 dark:via-stone-900/90 to-transparent pointer-events-none"
              style={{ 
                opacity: 0, 
            ...
            <button
              ...
              className={cn(
                ...
                isImageMode ? "text-purple-600 dark:text-purple-400" : isWebSearchMode ? "text-blue-600 dark:text-blue-400" : "text-stone-400 dark:text-stone-500",
                !expanded ? "opacity-100 scale-100 translate-y-0" : "opacity-0 scale-105 translate-y-1 pointer-events-none"
              )}
              aria-label="Open prompt input"
            >
              {isImageMode ? "🎨 Görsel Üretim Modu Aktif (yazın...)" : isWebSearchMode ? "🌐 Web Arama Modu Aktif (yazın...)" : placeholder}
            </button>
            ...
            >
              <div className="relative">
                <button
                  ...
                  className={cn(
                    "group flex items-center gap-1.5 rounded-full px-2.5 py-1 text-stone-600 dark:text-stone-300 transition-all duration-200 outline-none hover:bg-stone-100 dark:hover:bg-stone-800 cursor-pointer",
                    isModelSelectOpen ? "bg-stone-100 dark:bg-stone-800 text-stone-900 dark:text-stone-100" : ""
                  )}
                ...
                <div
                  ...
                  className={cn(
                    "absolute bottom-full left-0 mb-2.5 z-50 w-48 rounded-2xl border border-stone-200 dark:border-stone-800 bg-white/95 dark:bg-stone-900/95 p-1 shadow-xl backdrop-blur-md flex flex-col gap-0.5 transition-all duration-400 cursor-default",
                    isModelSelectOpen
                ...
                >
                  <div className="relative flex flex-col gap-0.5">
                    <div style={hoverStyle} className="absolute left-0 right-0 top-0 h-8 -z-10 rounded-xl bg-stone-100 dark:bg-stone-800 pointer-events-none" />
                    {models.map((modelName, idx) => (
                      <button
                        ...
                        className="group relative flex h-8 w-full items-center justify-between rounded-xl px-2.5 py-1.5 text-left text-xs font-medium text-stone-700 dark:text-stone-200 outline-none active:scale-[0.98] cursor-pointer"
                      >
              ...
              <button
                ...
                className="group flex items-center gap-1 rounded-full px-2 py-1 text-stone-500 hover:text-stone-800 dark:hover:text-stone-200 transition-all duration-200 hover:bg-stone-100 dark:hover:bg-stone-800 outline-none cursor-pointer"
              >
              ...
              <button
                ...
                className={cn(
                  "flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-semibold transition-all duration-200 outline-none cursor-pointer",
                  isWebSearchMode
                    ? "bg-gradient-to-r from-blue-600 to-cyan-600 text-white shadow-md shadow-blue-500/25 ring-1 ring-blue-400/50"
                    : "text-stone-500 hover:text-stone-800 dark:hover:text-stone-200 hover:bg-stone-100 dark:hover:bg-stone-800"
                )}
                title={isWebSearchMode ? "Web Arama Modu Aktif (Kapatmak için tıkla)" : "Canlı Web Arama Modunu Aç (İnternetten güncel bilgiler tarar)"}
              >
                <Globe className={cn("size-3.5", isWebSearchMode ? "text-cyan-200" : "text-blue-500")} />
                <span className="text-xs select-none">
                  {isWebSearchMode ? "Web Ara" : "Web"}
                </span>
              </button>
            ...
            >
              {audioData.map((val, i) => (
                <div
                  key={i}
                  className="w-1 rounded-full bg-stone-900 dark:bg-stone-100 transition-[height] duration-75 ease-out"
            ...
            <button
              ...
              className="absolute right-2 bottom-2 z-[10] flex h-8 w-8 items-center justify-center bg-stone-900 dark:bg-stone-100 text-white dark:text-stone-900 transition-all duration-300 hover:opacity-90 outline-none focus-visible:ring-2 focus-visible:ring-stone-400 cursor-pointer"
            >
